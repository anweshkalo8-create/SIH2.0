      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div className="lg:col-span-7 relative rounded-xl border border-slate-800 bg-slate-900/80 p-3 backdrop-blur min-h-[400px] flex flex-col">
            ...
            <div className="relative flex-1 rounded-lg overflow-hidden flex">
              ...
              <div className="w-10 flex flex-col items-center justify-center pl-2 text-[10px] text-slate-400 font-mono select-none">
                <span className="text-[9px] text-slate-300 font-semibold mb-1">°C</span>
                <span>30</span>
                <div
                  className="w-3 my-1 rounded-sm flex-1 shadow-inner"
                  style={{
                    background: 'linear-gradient(to bottom, #8b0000, #ff0000, #ff7f00, #ffff00, #00ff00, #00ffff, #0000ff, #00008b)',
                  }}
                />
                <span>0</span>
              </div>
              ...
              {selectedObs && (
                <div className="absolute right-12 top-2 z-30 shadow-2xl">
                  <ProfilePanel
                    ...
                    variable={variable === 'current' ? 'temperature' : variable}
          ...
          <div className="lg:col-span-5 flex flex-col gap-3">
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-3 backdrop-blur">
              <div className="flex items-center justify-between mb-2">
                <span className="text-xs font-semibold text-white">Global Map (Sea Surface Temperature)</span>
              ...
              <div className="relative h-32 w-full rounded-lg overflow-hidden border border-slate-800 bg-slate-950 flex items-center justify-center">
                ...
                <svg viewBox="0 0 360 160" className="w-full h-full">
                  <defs>
                    <linearGradient id="globalMapGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <rect width="360" height="160" fill="url(#globalMapGrad)" />
                  ...
                  <rect x="175" y="60" width="45" height="35" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-dasharray="2,2" />
                </svg>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-2.5 backdrop-blur">
                <div className="text-[10px] text-slate-400 leading-tight">Sea Surface Temp (°C)</div>
                <div className="text-base font-bold text-cyan-400 mt-1">28.6 °C</div>
                <div className="text-[9px] text-slate-500 mt-0.5">Min: 18.2 · Max: 30.4</div>
              </div>

              <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-2.5 backdrop-blur">
                <div className="text-[10px] text-slate-400 leading-tight">Surface Current Speed</div>
                <div className="text-base font-bold text-purple-400 mt-1">0.75 m/s</div>
                <div className="text-[9px] text-slate-500 mt-0.5">Min: 0.01 · Max: 1.68</div>
              </div>

              <div className="rounded-xl border border-slate-800 bg-slate-900/80 p-2.5 backdrop-blur">
                <div className="text-[10px] text-slate-400 leading-tight">Sea Surface Height</div>
                <div className="text-base font-bold text-emerald-400 mt-1">0.42 m</div>
                <div className="text-[9px] text-slate-500 mt-0.5">Min: -0.63 · Max: 0.92</div>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-800 bg-slate-900/80 px-3 py-2 flex items-center justify-between text-xs backdrop-blur">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-400">Model Run Time:</span>
                <span className="font-semibold text-white">2h 15m</span>
              </div>
              <span className="text-[10px] text-slate-400 bg-slate-800 px-2 py-0.5 rounded">
                Next Output: <strong className="text-cyan-300">1h</strong>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-6 rounded-xl border border-slate-800 bg-slate-900/80 p-3 backdrop-blur flex flex-col">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-white">Vertical Section (Along 10°N)</span>
            ...
            <div className="relative h-44 w-full rounded-lg overflow-hidden border border-slate-800 bg-slate-950 flex items-center">
              <svg viewBox="0 0 380 160" className="w-full h-full">
                <defs>
                  <linearGradient id="vertSectionGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <rect x="45" y="10" width="310" height="130" fill="url(#vertSectionGrad)" />
                {/* Internal Isotherms */}
                <path d="M 45,35 Q 180,45 355,30" fill="none" stroke="rgba(255,255,255,0.4)" stroke-width="1" />
                <path d="M 45,65 Q 200,80 355,60" fill="none" stroke="rgba(255,255,255,0.3)" stroke-width="1" />
                <path d="M 45,95 Q 190,105 355,90" fill="none" stroke="rgba(255,255,255,0.2)" stroke-width="1" />
                
                {/* Y-Axis Depth Labels */}
                <text x="5" y="20" fill="#64748b" font-size="8">-1000</text>
                <text x="5" y="55" fill="#64748b" font-size="8">-2000</text>
                <text x="5" y="90" fill="#64748b" font-size="8">-3000</text>
                <text x="5" y="125" fill="#64748b" font-size="8">-4000</text>
                <text x="5" y="145" fill="#64748b" font-size="8">-5000</text>
                
                {/* X-Axis Longitude Labels */}
                <text x="55" y="152" fill="#64748b" font-size="8">60°E</text>
                <text x="130" y="152" fill="#64748b" font-size="8">80°E</text>
                <text x="210" y="152" fill="#64748b" font-size="8">100°E</text>
                <text x="290" y="152" fill="#64748b" font-size="8">120°E</text>
                <text x="175" y="158" fill="#94a3b8" font-size="8">Longitude</text>
              </svg>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 rounded-xl border border-slate-800 bg-slate-900/80 p-3 backdrop-blur flex flex-col">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-white">Time Series (Past 10 Days)</span>
              <div className="flex items-center gap-3 text-[10px]">
                <span className="text-cyan-400 font-medium">● SST (°C)</span>
                <span className="text-emerald-400 font-medium">● SSS (psu)</span>
                <span className="text-purple-400 font-medium">● SSH (m)</span>
              </div>
            </div>
            <div className="h-44 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={TIME_SERIES_DATA} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" />
                  <XAxis dataKey="date" stroke="#64748b" fontSize={9} />
                  <YAxis yAxisId="left" stroke="#64748b" fontSize={9} domain={[25, 36]} />
                  <YAxis yAxisId="right" orientation="right" stroke="#64748b" fontSize={9} domain={[-1, 1]} />
                  <Tooltip contentStyle={{ background: '#0f172a', border: '1px solid #334155', borderRadius: 8, fontSize: 11 }} />
                  <Line yAxisId="left" type="monotone" dataKey="sst" stroke="#22d3ee" strokeWidth={2} dot={{ r: 2 }} />
                  <Line yAxisId="left" type="monotone" dataKey="sss" stroke="#34d399" strokeWidth={1.5} dot={{ r: 2 }} />
                  <Line yAxisId="right" type="monotone" dataKey="ssh" stroke="#a855f7" strokeWidth={1.5} dot={{ r: 2 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-6 rounded-xl border border-slate-800 bg-slate-900/80 p-4 backdrop-blur flex items-center justify-between">
            <div className="space-y-1.5 text-xs">
              <h3 className="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-2">Model Information</h3>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Model Name</span>
                <span className="font-medium text-white">: OceanVerse (INCOIS ROMS)</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Model Type</span>
                <span className="font-medium text-cyan-300">: ROMS</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Resolution</span>
                <span className="font-medium text-white">: 1/12° (~9 km)</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Layers</span>
                <span className="font-medium text-white">: 50</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Assimilation</span>
                <span className="font-medium text-white">: Hybrid</span>
              </div>
              <div className="flex gap-2">
                <span className="text-slate-400 w-28">Next Run</span>
                <span className="font-medium text-amber-300">: 21 May 2025, 16:00 UTC</span>
              </div>
            </div>
            ...
            <div className="pr-4 flex flex-col items-center">
              <div className="grid h-24 w-24 place-items-center rounded-full bg-cyan-500/10 text-cyan-400 ring-2 ring-cyan-400/30 shadow-lg shadow-cyan-500/20">
                <Globe size={56} className="animate-spin" style={{ animationDuration: '25s' }} />
              </div>
              <span className="mt-2 text-[10px] text-cyan-300/80 font-mono">Global Coverage</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 rounded-xl border border-slate-800 bg-slate-900/80 p-3 backdrop-blur flex flex-col">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-semibold text-white">In-situ Observations vs Model (SST)</span>
              <div className="flex items-center gap-3 text-[10px]">
                <span className="text-cyan-400">● Observations</span>
                <span className="text-emerald-400">— 1:1 Fit Line (R² = 0.94)</span>
              </div>
            </div>
            <div className="h-44 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <ScatterChart margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#1e293b" />
                  <XAxis type="number" dataKey="observed" name="Observed" domain={[18, 32]} stroke="#64748b" fontSize={9} />
                  <YAxis type="number" dataKey="model" name="Model" domain={[18, 32]} stroke="#64748b" fontSize={9} />
                  <Tooltip cursor={{ strokeDasharray: '3 3' }} contentStyle={{ background: '#0f172a', border: '1px solid #334155', borderRadius: 8, fontSize: 11 }} />
                  <Scatter name="Observations" data={VALIDATION_DATA} fill="#22d3ee" />
                  <Line type="linear" dataKey="model" stroke="#34d399" strokeWidth={1.5} dot={false} />
                </ScatterChart>
              </ResponsiveContainer>
            </div>
          </div>
